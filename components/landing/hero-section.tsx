    ...
    <section id="hero" className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center overflow-hidden px-4 py-10 sm:py-14 md:py-16 gradient-mesh-bg">
      ...
      <div className="relative z-10 mx-auto max-w-7xl w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-6 items-center my-auto">
        ...
        >
          ...
          <div className="mt-3 min-h-10.5 flex items-center justify-center lg:justify-start">
            <p className={`text-sm sm:text-base md:text-lg font-extrabold text-[#1E3A8A] transition-opacity duration-300 ${isFading ? 'opacity-0' : 'opacity-100'}`}>
              <span className="text-cyan-glow">{displayText}</span>
              <span className="cursor-underscore text-[#0EA5E9] font-extrabold ml-0.5">_</span>
            </p>
          </div>

          <p className="mt-3 max-w-lg text-xs sm:text-sm text-slate-600 leading-relaxed font-medium">
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-[250px] sm:max-w-[265px] aspect-[9/18.5] max-h-[430px] rounded-[36px] bg-[#111827] p-2 shadow-2xl shadow-[#1E3A8A]/25 border-4 border-slate-700/60 gpu-accelerated my-auto"
          >
